    ...
    */ 
    ...
    void UpgradeInventory()
    {
        ...
        if (playerClass.inventoryVal >= upgrInventoryCost)
        {
            ...
            // man bliver nemmere opdaget, n�r man har st�rre inventory
    ...
    void UpgradeDisguise()
    {
        ...
        if (playerClass.disguiseVal >= upgrDisguiseCost)
        {
            ...
            // Man skal t�ttere p� AIs for at blive opdaget og man skal v�re i deres FoV i l�ngere tid.
            ...
            else
            {
                ...
                Debug.Log("You won the game!"); // Man vinder, n�r AIs ikke l�ngere ser spilleren
            }
